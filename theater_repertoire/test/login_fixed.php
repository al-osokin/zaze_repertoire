...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (authenticateUser($username, $password)) {
        // Проверяем, не было ли уже выведено что-то в output
...
<head>
    ...
    <title>Исправленный вход - Репертуар театра</title>
    <style>
        body {
...
<body>
    <div class="login-form">
        <h2 style="text-align: center; margin-bottom: 20px;">Исправленный вход в систему</h2>

        <div class="debug-info">
            <strong>Отладочная информация:</strong><br>
            Session ID: <?php echo session_id(); ?><br>
            Headers sent: <?php echo headers_sent() ? 'Yes' : 'No'; ?><br>
            Output buffering: <?php echo ob_get_level(); ?> level(s)
        </div>
