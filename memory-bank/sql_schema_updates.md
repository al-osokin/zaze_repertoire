# Обновления схемы базы данных для проекта "Администрирование Афиши Театра"

Этот документ содержит SQL-скрипты для создания новых таблиц и модификации существующей таблицы `events_raw`, как описано в плане разработки.

## 1. Добавляемые таблицы
